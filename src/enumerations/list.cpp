...
REGISTERDEFAULT(enumerator::enumerations::Enumeration, enumerator::enumerations::List, "Simple list of arguments",
         ARG(std::string, "name", "the template variable name"),
