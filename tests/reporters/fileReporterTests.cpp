...
INSTANTIATE_TEST_SUITE_P(
    SutherlandTests, FileReporterTestFixture,
    testing::Values((FileReporterTestParameters){.cases = {std::make_pair("case1.", std::map<std::string, std::string>{{"a", "1"}, {"b", "2"}})}, .expectedString = "case1.\n\ta: 1\n\tb: 2\n"},
                    (FileReporterTestParameters){.cases = {
